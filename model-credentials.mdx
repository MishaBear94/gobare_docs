...
description: "You want to connect a model without opening the Console"
---
...
[Switching model providers](/guides/switching-model-providers).
...
[troubleshooting.md](/troubleshooting#refused-model-or-credential).

## Next

- [quickstart](/quickstart) — use the connection
- [switching model providers](/guides/switching-model-providers) — run the same task on another provider
