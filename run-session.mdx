...
description: "The loop, written out, to copy into your project"
---

The loop from [the quickstart](/quickstart), as a file to copy. It is not a
package on purpose — see [design-decisions](/design-decisions) — and it is not
a transcription either: `pnpm e2e:v1:minimax` runs against production through
this exact file, so it cannot rot without a test going red.
