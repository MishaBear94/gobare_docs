---
title: "Preview"
description: "You want what the agent built to be reachable by other people"
---
...
[design-decisions.md](/design-decisions) on why `DELETE` destroys the
...
[errors.md](/errors); if you have a symptom rather than a code, start at
[troubleshooting.md](/troubleshooting).

## Next

- [input.md](/input) — asking the agent to serve something
- [sessions.md](/sessions) — giving the session a repository to build from
- [guides/an-agent-behind-your-api.md](/guides/an-agent-behind-your-api) — running this from your own backend
