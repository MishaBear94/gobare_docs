---
title: "Turn documents into structured JSON"
description: "Turn a pile of PDFs, contracts or reports into rows in my database"
---
...
Three things, and the [quickstart](/quickstart) covers all of them:
...
`POST /v1/sessions/{session_id}/files`. See [sessions.md](/sessions).
...
Using [webhooks](/webhooks) instead? Then ignore all of this:
...
retrying. [An agent behind your API](/guides/an-agent-behind-your-api) has the loop.
...
| `400` naming a field | A field this API does not read | The message names it; [errors.md](/errors) |
...
- [Put an agent behind your own API](/guides/an-agent-behind-your-api) — draining a queue without waiting
- [sessions.md](/sessions) — repositories, files afterwards, environment profiles
- [limits.md](/limits) — every ceiling named here, with its number
