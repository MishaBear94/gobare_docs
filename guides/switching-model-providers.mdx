---
title: "Swap model providers without changing your code"
description: "Change model or vendor without touching my code"
---
...
scope. See [model-credentials.md](/model-credentials).
