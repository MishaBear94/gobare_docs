---
title: "Errors"
description: "Something returned a code you have not seen"
---
...
- `rate_limit_exceeded` — you are asking too fast. `Retry-After` says how long
  to wait, and honouring it works. See [limits.md](/limits).
...
- [input](/input) — what each input event accepts, and when each refusal happens
- [troubleshooting](/troubleshooting) — a symptom rather than a code
- [limits](/limits) — the ceilings behind the 429s
