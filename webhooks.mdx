---
title: "Webhooks"
description: "You want to be told rather than to watch"
---
...
[troubleshooting.md](/troubleshooting) for symptoms and
[errors.md](/errors) for the refusal shape.

## Next

- [events](/events) — watch a single session live instead
- [idempotency](/idempotency) — deliveries arrive at least once
